...
def KeyInject(civitai_key, hf_token):
    SyS(f'curl -sLo {nenen} https://github.com/JohnGrisham/segsmaker/raw/main/script/nenen88.py')
...
def CondaMisc():
    for scr in [
        f'curl -sLo {css} https://github.com/JohnGrisham/segsmaker/raw/main/script/SM/segsmaker.css',
        f'curl -sLo {startup}/00-startup.py https://github.com/JohnGrisham/segsmaker/raw/main/script/SM/00-startup.py',
        f'curl -sLo {startup}/util.py https://github.com/JohnGrisham/segsmaker/raw/main/script/SM/util.py',
        f'curl -sLo {img} https://github.com/JohnGrisham/segsmaker/raw/main/script/loading.png',
        f'curl -sLo {startup}/cupang.py https://github.com/JohnGrisham/segsmaker/raw/main/script/cupang.py'
    ]: SyS(scr)
